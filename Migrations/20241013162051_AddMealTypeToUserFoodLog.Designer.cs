...
namespace MacroTracker.Migrations
{
    ...
    [Migration("20241013162051_AddMealTypeToUserFoodLog")]
    partial class AddMealTypeToUserFoodLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MacroTracker.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MacroTracker.Models.UserFoodLog", b =>
                {
                    ...
                    b.HasOne("MacroTracker.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MacroTracker.Models.UserProfile", null)
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MacroTracker.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
